      ...
      */}
      ...
      >
        ...
        */}
        ...
        {/* Floating HUD Overlays around the orb */}
        <div className="absolute top-[10%] left-[-35%] desktop-sm:left-[-45%] z-35 flex items-center gap-2 rounded-full border border-[#c98bff]/30 bg-black/60 px-3.5 py-1.5 backdrop-blur-md shadow-[0_0_15px_rgba(201,139,255,0.15)] animate-bounce [animation-duration:4s] whitespace-nowrap hidden ipad:flex">
          <span className="w-2 h-2 rounded-full bg-purple-400 animate-pulse" />
          <span className="font-sans text-[10px] desktop-sm:text-xs font-semibold tracking-wider text-white">128 ACTIVE ORDERS</span>
        </div>

        <div className="absolute top-[45%] right-[-35%] desktop-sm:right-[-45%] z-35 flex items-center gap-2 rounded-full border border-[#c98bff]/30 bg-black/60 px-3.5 py-1.5 backdrop-blur-md shadow-[0_0_15px_rgba(201,139,255,0.15)] animate-bounce [animation-duration:5s] whitespace-nowrap hidden ipad:flex">
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
          <span className="font-sans text-[10px] desktop-sm:text-xs font-semibold tracking-wider text-white">94.2% FULFILLMENT</span>
        </div>

        <div className="absolute bottom-[20%] left-[-25%] desktop-sm:left-[-35%] z-35 flex items-center gap-2 rounded-full border border-red-500/40 bg-black/60 px-3.5 py-1.5 backdrop-blur-md shadow-[0_0_15px_rgba(239,68,68,0.15)] animate-bounce [animation-duration:4.5s] whitespace-nowrap hidden ipad:flex">
          <span className="w-2 h-2 rounded-full bg-red-500 animate-ping" />
          <span className="font-sans text-[10px] desktop-sm:text-xs font-semibold tracking-wider text-red-300">7 CRITICAL ALERTS</span>
        </div>

        <div className="absolute top-[75%] right-[-25%] desktop-sm:right-[-35%] z-35 flex items-center gap-2 rounded-full border border-violet-500/30 bg-black/60 px-3.5 py-1.5 backdrop-blur-md shadow-[0_0_15px_rgba(201,139,255,0.15)] animate-bounce [animation-duration:6s] whitespace-nowrap hidden ipad:flex">
          <span className="w-2 h-2 rounded-full bg-violet-400 animate-pulse" />
          <span className="font-sans text-[10px] desktop-sm:text-xs font-semibold tracking-wider text-white">AI DECISION READY</span>
        </div>
      </div>
    </div>
  );
